        ...
        <div class="grid-content leftNote">
          <el-table :data="tableNote" style="width: 100%; ">
            ...
            <el-table-column prop="createTime" label="创建日期" width="200">
              <template slot-scope="scope">
                {{ scope.row.createTime == null ? null : scope.row.createTime.replace("T", " ") }}
              </template>
            </el-table-column>

            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button size="mini" type="danger" icon="el-icon-delete" @click="DeleteNote(scope.$index, scope.row)">
                  删除
                </el-button>
              </template>
            </el-table-column>
    ...
    <el-col :span="17">
      <el-row>
        <div style="margin-top:33px">
          <el-input class="selectNote" v-model="dataForm.select" placeholder="请输入笔记名称" clearable
                    @clear='getNoteDateList'></el-input>
